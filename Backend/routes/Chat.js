...
import { createChat, createMessage, deleteMessage, getConversation, getCuurentConversations, markMessageAsRead, markAllMessagesAsRead } from '../controllers/Chat.js'
import validateToken from '../middlewares/validateTokenHandle.js';

router.route('/message/:messageId/read').patch(validateToken, markMessageAsRead);
