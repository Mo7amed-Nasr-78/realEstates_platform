        ...
        <section className="w-full h-screen flex items-center justify-center lg:justify-between bg-(--bg-color)">
            <div className="w-full md:w-3/4 lg:w-1/2 h-full flex flex-col items-center justify-center px-5 md:px-10 lg:px-14 xl:px-20">
                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col items-start mb-4">
                    ...
                    <input type="password" name="newPass" id="newPass" placeholder="Enter Your New Password" className="h-13 w-full rounded-[20px] px-4 sm:px-6 bg-[#676e80bd]/25 text-lg text-(--primary-text) placeholder:font-light placeholder:text-(--tertiary-color) mb-4 focus:outline-2 focus:outline-(--primary-color)" autoComplete="false"/>
                    ...
                    <input type="password" name="confirmPass" id="confirmPass" placeholder="Enter Your Confirm Password" className="h-13 w-full rounded-[20px] px-4 sm:px-6 bg-[#676e80bd]/25 text-lg text-(--primary-text) placeholder:font-light placeholder:text-(--tertiary-color)  mb-6 focus:outline-2 focus:outline-(--primary-color)" autoComplete="false"/>
