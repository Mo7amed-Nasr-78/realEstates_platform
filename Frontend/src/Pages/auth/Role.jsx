            ...
            <div className="md:w-3/4 lg:w-1/2 h-full flex-col flex items-center justify-center px-5 md:px-10 lg:px-14 xl:px-20">
                ...
                <form onSubmit={handleSubmit} className="w-full mb-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 mb-8">
                        <label htmlFor="finder" className="sm:w-[50%] flex sm:flex-col items-center gap-3 px-3 sm:px-8 py-3 sm:py-14 has-[input:checked]:bg-(--secondary-color)/25 has-[input:checked]:border-(--primary-color) bg-(--secondary-color) hover:bg-[#38405480] rounded-4xl transition duration-300 ease-in-out border border-(--secondary-color) hover:border-(--primary-color) cursor-pointer">
                            ...
                            <input onChange={handleChange} type="radio" name="role" id="finder" value="finder" className="hidden"/>
                        </label>
                        <label htmlFor="agent" className="sm:w-[50%] flex sm:flex-col items-center gap-3 px-3 sm:px-8 py-3 sm:py-14 has-[input:checked]:bg-(--secondary-color)/25 has-[input:checked]:border-(--primary-color) bg-(--secondary-color) hover:bg-[#38405480] rounded-4xl transition duration-300 ease-in-out border border-(--secondary-color) hover:border-(--primary-color) cursor-pointer">
                            <div className="min-w-12 min-h-12 sm:min-w-18 sm:min-h-18 flex items-center justify-center rounded-full bg-[#51c20640]">
                                <PiUserLight className="text-2xl sm:text-4xl text-(--primary-text)"/>
                            </div>
                            ...
                            <input onChange={handleChange} type="radio" name="role" id="agent" value="agent" className="hidden"/>
                        </label>
                    </div>
